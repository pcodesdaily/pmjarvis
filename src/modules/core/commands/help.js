    ...
    const embed = new EmbedBuilder()
      ...
      .setDescription(
        [
          ...
          "4. Pick the one you want from the list",
          "",
          "Ask for another song at any time and it joins the queue behind the",
          "current one. When the queue runs out, similar songs keep playing.",
          "",
